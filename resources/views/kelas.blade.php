...
<head>
    ...
    <title>Kelas Pelatihan - Pelatihan Iklan Digital</title>
...
@php
    $courses = [
        [
            ...
            'description' => 'Belajar Facebook Ads Nggak Harus Ribet Dan Mahal',
            'duration' => '2 jam leg',
            'mode' => 'Seal Online',
            'date' => 'Rabu, 03 Sep 2025',
            'time' => '09:00 - 11:00 WIB',
            'instructor' => 'Mas Bayu'
        ],
        [
            'title' => 'ADVANCED CLASS',
            'description' => 'Algoritma Facebook Makin Pintar — Kalau Kamu Masih Pakai Cara Lama, Siap-Siap Iklan Boncos Terus',
            'duration' => '3 jam leg',
            'mode' => 'Seal Online',
            'date' => 'Selasa, 02 Sep 2025',
            'time' => '09:00 - 12:00 WIB',
            'instructor' => 'Mas Bayu'
        ],
        [
            'title' => 'BEGINNER TO ADVANCED',
            'description' => 'Sekolah Advertiser for Beginners',
            'duration' => '2 jam leg',
            'mode' => 'Seal Online',
            'date' => 'Senin, 01 Sep 2025',
            'time' => '09:00 - 11:00 WIB',
            'instructor' => 'Mas Bayu'
        ],
        [
            'title' => 'JAGOAN CS',
            'description' => 'Jagoan Customer Service Jogja',
            'duration' => '2 jam leg',
            'mode' => 'Seal Online',
            'date' => 'Senin, 01 Sep 2025',
            'time' => '09:00 - 11:00 WIB',
         ...
         [
            'title' => 'SHOPPE ADS',
            'description' => 'Saatnya Pinter-Pinteran Bidding Shopee Ads!',
            'duration' => '2 jam leg',
            'mode' => 'Seal Online',
            'date' => 'Senin, 01 Sep 2025',
            'time' => '09:00 - 11:00 WIB',
            'instructor' => 'Mas Mahdi'
        ],
    ];
    @endphp
                    ...
                    <div class="class-card">
                        <div class="card-header">
                            <div class="flex justify-between items-center mb-2">
                                <span class="class-badge bg-purple-100 text-purple-800">3 jam leg</span>
                                <span class="class-badge bg-blue-100 text-blue-800">Seal Online</span>
                            </div>
                            <h3 class="text-lg font-bold text-white">{{$course['title']}}</h3>
                        </div>
                        <div class="p-5">
                            <h4 class="text-md font-semibold text-gray-800 mb-4 leading-tight">{{$course['description']}}</h4>
                        </div>
                        <div class="divider"></div>
                        <div class="text-center pb-4">
                            <a href="#detail-{{ $loop->index }}" class="detail-button">
